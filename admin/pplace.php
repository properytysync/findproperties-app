...
// Pagination settings
$recordsPerPage = 10; // Number of entries per page
$currentPage = isset($_GET['page']) ? $_GET['page'] : 1;
$startFrom = ($currentPage - 1) * $recordsPerPage;

// Sorting settings
$sort_order = isset($_GET['sort']) ? $_GET['sort'] : 'sid'; // Default sort order
$sort_direction = isset($_GET['dir']) ? $_GET['dir'] : 'ASC'; // Default sort direction

// Fetch sorted and paginated data for states
$query = "SELECT sid, sname, image_path FROM state ORDER BY $sort_order $sort_direction LIMIT $startFrom, $recordsPerPage";
...
$totalRecordsQuery = "SELECT COUNT(*) AS total FROM state";
...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
    <style>
        ...
        .div-table-row {
            display: flex;
            width: 100%;
            min-height: 50px; /* Ensures uniform row height */
        }
...
<body>
              ...
              <div class="row">
                ...
                <div class="col-sm-6 p-0">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Popular Places</li>
					<li class="breadcrumb-item"><a href="create_state.php">Create Location</a></li>
                  </ol>
                </div>
              </div>
            </div>
    ...
    <div class="div-table">
        <div class="div-table-row div-table-header">
            ...
            <div class="div-table-cell">State Name</div>
            <div class="div-table-cell">Image</div>
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                echo "<div class='div-table-row'>
                        <div class='div-table-cell'>" . htmlspecialchars($row['sid']) . "</div>
                        <div class='div-table-cell'>" . htmlspecialchars($row['sname']) . "</div>
                        <div class='div-table-cell'><img src='../" . htmlspecialchars($row['image_path']) . "' alt='" . htmlspecialchars($row['sname']) . "'></div>
                        <div class='div-table-cell'>
                            <a href='edit_state.php?sid=" . $row['sid'] . "'>Edit</a> 
                        </div>
                      </div>";
            }
        } else {
            echo "<div class='div-table-row'><div class='div-table-cell' colspan='4'>No states found</div></div>";
        }
        ?>
    </div>
