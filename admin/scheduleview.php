              ...
              <div class="row">
                ...
                <div class="col-sm-6 p-0">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Schedule Viewings</li>
                  </ol>
                </div>
              </div>
            </div>
						...
						<div class="col-sm-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">Paid Schedule Viewings</h4>
									<?php 
											if(isset($_GET['msg']))	
											echo $_GET['msg'];
								...
								<div class="card-body">
									...
									<table id="basic-datatable" class="table">
											...
											<?php
												...
												$query=mysqli_query($con,"SELECT * FROM contact WHERE payment_status = 'paid'");
												$cnt=1;
											...
											?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $row['6'] ?? 'N/A'; ?></td>
                                                    <td><?php echo ucfirst($row['7'] ?? 'paid'); ?></td>
