...
<div class="container-fluid px-3 px-md-4">
    ...
    <div class="row g-3">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header"><strong>WhatsApp Notifications (Meta Cloud API)</strong></div>
                <div class="card-body">
                    <form method="post" class="row g-3">
                        ...
                        <div class="col-12">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="wa_enabled" name="wa_enabled" value="1" <?php echo ($wa_enabled==='1'?'checked':''); ?>>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input class="form-control" name="wa_phone_id" value="<?php echo h($wa_phone_id); ?>" placeholder="e.g. 123456789012345">
                        </div>

                        <div class="col-12 col-md-6">
                            <label class="form-label">Sender label</label>
                            <input class="form-control" name="wa_from_label" value="<?php echo h($wa_from_label); ?>" placeholder="PropertySync CRM">
                        </div>

                        <div class="col-12">
                            <label class="form-label">Permanent Access Token</label>
                            <textarea class="form-control" name="wa_token" rows="3" placeholder="Paste token here"><?php echo h($wa_token); ?></textarea>
                            <div class="text-muted small">Keep this private.</div>
                        </div>

                        <div class="col-12">
                            <button class="btn btn-primary">Save WhatsApp Settings</button>
                        </div>
                    </form>
                </div>
            </div>
