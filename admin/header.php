                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="submenu">
								<a href="adminlist.php"><i class="fe fe-user"></i> <span> Users </span> <span class="menu-arrow"></span></a>
							...
							<li class="submenu">
								<a href="#"><i class="fe fe-user"></i> <span> Contact Us </span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
